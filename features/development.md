...
| Packaging and docs | Coordinator | Sample hosts, Framework compatibility | Planned | NuGet packaging/versioning and a desktop/legacy .NET Framework integration example remain outstanding |
