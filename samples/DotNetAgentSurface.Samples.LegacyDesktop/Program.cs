...
using DotNetAgentSurface.Samples.LegacyDesktop;

var services = new SingleServiceProvider(new GreeterService());
var catalog = OperationCatalog.Discover(typeof(GreeterService));
