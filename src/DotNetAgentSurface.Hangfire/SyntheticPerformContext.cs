...
/// <summary>
/// A real Hangfire <see cref="global::Hangfire.Server.PerformContext"/> created by <see cref="SyntheticPerformContextFactory"/>,
...
{
    /// <summary>
    /// Gets the synthetic <see cref="global::Hangfire.Server.PerformContext"/>.
    /// </summary>
    public PerformContext Context { get; } = context;

    /// <summary>
    /// Gets the <see cref="global::Hangfire.IJobCancellationToken"/> supplied to <see cref="Context"/>, exposed directly so
